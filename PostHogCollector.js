...
class PostHogCollector {
  ...
  init() {
    ...
    //posthog.init('phc_aDprQSPEqgRugAsvqWpuCwOp2zihhQThU6edDQ22b7O', {api_host: 'https://us.i.posthog.com'})
    posthog.init(this.apiKey, { api_host: this.apiHost, autocapture: this.autocapture });
  }
